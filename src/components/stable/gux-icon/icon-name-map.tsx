export const iconNameMap: Record<string, string> = {
  ...
  'interactions-alpha': 'user-interactions',
  'add-user': 'user-add',
  ...
  'ic-interactions-off-alpha': 'user-interactions-disable',
  'interactions-off-alpha': 'user-interactions-disable',
  ...
  // - Product Logos
  'beyond-logo': 'productlogo-beyond',
  'ic-special-g-brandmark': 'productlogo-g',
  'logo-genesys': 'productlogo-g',
  // - Left Toolbar
  ...
  'phone-active-1': 'toolbar-phone-active1',
  'phone-active-2': 'toolbar-phone-active2',
  'phone-active-3': 'toolbar-phone-active3',
  ...
  certificate: 'toolbar-certificate',
  ...
  'ic-inspect-disabled': 'inspect-disabled',
  hide: 'inspect-disabled',
  whistle: 'coaching',
  ...
  // Charts
  'ic-bar-graph-variable-1': 'graph-bar-h',
  'ic-graph-barline': 'graph-bar-h',
  'ic-24-graph-bar': 'graph-bar-h',
  'ic-graph-bar': 'graph-bar-h',
  'ic-graph-stack': 'graph-bar-h',
  'ic-24-graph-stack': 'graph-bar-h',
  'ic-bar-graph-variable-2': 'graph-bar-v',
  'ic-24-graph-bar-vertical': 'graph-bar-v',
  'ic-24-graph-stack-vertical': 'graph-bar-v',
  ...
  'ic-dropdown-arrow': 'chevron-sm-down',
  'ic-iw-circle-no-chevron-down': 'chevron-sm-down',
  'ic-arrow-accordian': 'chevron-sm-down',
  // 'missing': 'chevron-sm-down',
  'ic-iw-circle-no-chevron-up': 'chevron-sm-up',
  'ic-chevron-small-left': 'chevron-sm-left',
  'angle-left': 'chevron-sm-left',
  'ic-chevron-small-right': 'chevron-sm-right',
  'angle-right': 'chevron-sm-right',
  'ic-arrow-left-dbl': 'chevron-dbl-left',
  'ic-disclosure-left': 'chevron-dbl-left',
  'ic-arrow-right-dbl': 'chevron-dbl-right',
  'ic-arrow-disclosure': 'chevron-dbl-right',
  ...
  'ic-more': 'manu-kebab-v',
  'ellipsis-v': 'manu-kebab-v',
  ...
  'ic-grip-horizontal': 'grab-h',
  'ic-grab': 'grab-h',
  'ic-grip-vertical': 'grab-v',
  'ic-grab-vertical': 'grab-v',
  'sign-out': 'logout',
  'ic-out': 'logout',
  'ic-export': 'logout',
